<footer class="footer">
    <div class="w-100 clearfix">
        <span class="text-center text-sm-left d-md-inline-block">Doctor Management System © 2022 ThemeKit v2.0. All Rights Reserved.</span>
        <span class="float-none float-sm-right mt-1 mt-sm-0 text-center">Crafted with <i class="fa fa-heart text-danger"></i> by <a href="https://ilmi-tabassum.github.io/portfolio/" class="text-dark" target="_blank">Ilmi Tabassum</a></span>
    </div>
</footer>
